...
CREATE view [dbo].[PO_REPORT_LINESv_OLD] 
as
SELECT top 10
POL_POTID
,POL_LP
...
,POL_BIZ_DEC_DESC
,POL_PARTIAL
,ISNULL(POL_NTX01,0) as POL_NTX01
,POL_DTX01
,POL_NOTE
...
,POL_BIZ_NETTO = case when POL_BIZ_DEC = 1 then POL_NTX01 end
,POL_TECH_NETTO = case when POL_BIZ_DEC = 0 then POL_NTX01 end
