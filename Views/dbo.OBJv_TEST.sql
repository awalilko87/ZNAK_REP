...
from dbo.OBJ (nolock) o              
 ...
 outer apply (select top 1 SRQ_TYPE_DESC, SRQ_STATUS_DESC, SRQ_NR_ZAW_PM from dbo.SP_REQUESTv req where o.OBJ_ROWID = SRQ_OBJID and SRQ_STATUS  in ('SRQ_001', 'SRQ_007', 'SRQ_008') order by SRQ_ROWID desc)srq            
where             
