...
GO
CREATE procedure [dbo].[POT_mail_conf] (  
...
SELECT DISTINCT  
   ...
   ,  
   '<pre><b>Protokół Oceny Technicznej</b>    nr: <b>' + POT_CODE + '</b>  
...
Prosimy na nią nie odpowiadać.  
   ...
   , null  
           from OBJTECHPROT  
join SYUsers on UserID = POT_CREUSER--in (CHK_GU_DZR_USER, CHK_GU_IT_USER, CHK_GU_RKB_USER, CHK_GU_UR_USER)  
