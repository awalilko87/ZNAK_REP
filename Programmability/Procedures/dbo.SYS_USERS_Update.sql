...
CREATE PROCEDURE [dbo].[SYS_USERS_Update](
	@Admin bit = NULL,
	@OLD_Admin bit = NULL,
...
BEGIN TRAN 
	...
	*/
	...
	begin
		...
		[MobileUser], [MobileAuthUser], ADLogin, [UserGroupID2])
		values (
		...
		@MobileUser, isnull(@MobileAuthUser, 0), @ADLogin, UPPER(sys.fn_varbintohexstr(HashBytes('MD5',@UserID+'VISION'+@UserGroupID))))
	end 
	else 
	begin 
