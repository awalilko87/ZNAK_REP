...
GO
CREATE procedure [dbo].[ZWFOT11_Update_Proc]     
(    
...
begin    
 ...
 if not exists (select * from dbo.OBJSTATION (nolock) where OSA_OBJID = @v_OBJID) and @v_OBJID is not null and isnull(@p_OBJKEYS ,'') <> ''    
   ...
   if  @p_STATUS = 'OT11_70' AND @p_STATUS <> @p_STATUS_OLD
		BEGIN
		UPDATE obj
		SET 
		OBJ_OTID = null,
		OBJ_CANCELLED_OT_DOC = case when OBJ_CANCELLED_OT_DOC is null then @p_CODE else OBJ_CANCELLED_OT_DOC + ', ' + @p_CODE end,
		OBJ_CANCELLED_OT_DOC_PERSON = case when OBJ_CANCELLED_OT_DOC_PERSON is null then @p_UserID else OBJ_CANCELLED_OT_DOC_PERSON + ', ' + @p_UserID end
		WHERE OBJ_CODE = @p_ZMT_OBJ_CODE

		UPDATE ZWFOT
		SET OT_INOID = NULL
		WHERE OT_CODE = @p_CODE
		END
 --++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++         
 --+++++++++++++++++++++++++++++++++++++++++INSERT+++++++++++++++++++++++++++++++++++++++++++    
 --++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
