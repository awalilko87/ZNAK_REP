...
GO
CREATE procedure [dbo].[STATION_Update_Proc]   
(  
 @p_FormID nvarchar(50),  
 @p_ID nvarchar(50),  @p_ROWID int,  @p_CODE nvarchar(30),  @p_DESC nvarchar(80),  
 ...
 @p_CCD nvarchar(30),    
 @p_KL5 nvarchar(30),    @p_NOTUSED int,   @p_ORG nvarchar(30),    
...
if exists (select 1 from STATION where STN_CODE = @p_CODE and STN_KL5ID = @p_KL5)
	begin
		RaisError('Stacja o podanych parametrach już istnieje',16,1)
	end
