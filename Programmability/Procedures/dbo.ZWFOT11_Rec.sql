...
GO
CREATE procedure [dbo].[ZWFOT11_Rec] 
(
    @p_ID nvarchar(50),
    @p_TYPE nvarchar(30),
	@p_FIDP nvarchar(50),  
...
, [OT_SZABLON] = (case when exists (select 1 from dbo.ZWFOT_TEMPLATE where OTID = OT_ROWID and USERID = @p_UserID) then 1 else 0 end)

	FROM [dbo].[ZWFOT11v] (NOLOCK) 
	WHERE 1 = 1  and [OT_ID] = @p_ID and [OT_TYPE] = @p_TYPE 
