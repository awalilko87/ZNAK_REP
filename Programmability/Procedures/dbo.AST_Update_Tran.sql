...
GO
CREATE procedure [dbo].[AST_Update_Tran]
(
...
begin
  ...
  begin transaction
    exec @v_errorid = [dbo].[AST_Update_Proc] @p_FormID, @p_ID, @p_ROWID, @p_CODE, @p_ORG, @p_DESC, @p_NOTE, @p_DATE, @p_TIME, @p_STATUS, @p_STATUS_old, @p_TYPE, @p_TYPE2, @p_TYPE3, @p_NOTUSED, @p_TXT01, @p_TXT02, @p_TXT03, @p_TXT04, @p_TXT05, @p_TXT06, @p_TXT07, @p_TXT08, @p_TXT09, @p_NTX01, @p_NTX02, @p_NTX03, @p_NTX04, @p_NTX05, @p_COM01, @p_COM02, @p_DTX01, @p_DTX02, @p_DTX03, @p_DTX04, @p_DTX05
