...
GO
CREATE procedure [dbo].[PZO_mail_PZO_002] (
...
SELECT DISTINCT
			...
			,
			'<pre>W systemie ZMT został wystawiony nowy <b>Protokół Zdawczo-Odbiorczy</b>
nr: <b>' + POT_CODE + '</b>

<a href = "' + (select top 1 SettingValue from SYSettings where KeyCode = 'LIC_WWW') + '/' + dbo.VS_EncryptLink(N'Link.aspx?B=' + dbo.VS_EncodeBase64(N'Tabs3.aspx/?MID=ZMT_INVEST&TGR=PZO&TAB=PZO_LS&FID=PZO_LS' + '&QSC=R09UT1RBQiAyOw==&DW=' + 'POT_ROWID=' + convert(varchar,POT_ROWID))) + '">LINK</a>
