...
CREATE PROCEDURE [dbo].[VS_FormFields_GetByFormIDToUse](
    @FormID nvarchar(50) = '%',
	  @UserID nvarchar(30) = '%'
)
WITH ENCRYPTION
...
--set statistics io on
	...
	SELECT
        ...
        coalesce(SYS_MsgField.Caption, VS_FormFields.Caption, VS_FormFields.FieldID) Caption, 
        CaptionStyle, 
        FieldName, 
        TableName,
		...
		coalesce(SYS_MsgField.GridColCaption, VS_FormFields.GridColCaption, VS_FormFields.Caption, VS_FormFields.FieldID) GridColCaption,
    ...
    WHERE VS_FormFields.FormID = @FormID AND NotUse = 0
