CREATE TABLE [dbo].[IE2_INW] (
  ...
  CONSTRAINT [PK_IE2_INW] PRIMARY KEY CLUSTERED ([ROWID])
)
ON [PRIMARY]
GO

CREATE INDEX [PG_20161125]
  ON [dbo].[IE2_INW] ([PSPHI])
  ON [PRIMARY]
GO

CREATE INDEX [PG_20190118]
  ON [dbo].[IE2_INW] ([POSKI])
  INCLUDE ([ROWID], [POSID], [PSPHI], [DOC_NEW_INSERTED])
  ON [PRIMARY]
GO